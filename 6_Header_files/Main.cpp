...
/*
- .h files are just to used to define the function. So when you use compiler knows that there is an function in header files
- .cpp files have function declaration. All the contents, the body and the characteristics of a function
