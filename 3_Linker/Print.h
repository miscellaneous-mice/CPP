...
#define Using_Header false // Delete #include "Print.h" in print.cpp and Arthematic.cpp for other examples
#define best_method !Using_Header

#if !best_method
static void Print(const char* message) // If you add static then when you include "Print.h" in Print.cpp and Arthematic.cpp then there are 2 different versions of this functioon in both files.
...
Then when you call #include "Log.h" in Print.cpp and Arthematic.cpp
